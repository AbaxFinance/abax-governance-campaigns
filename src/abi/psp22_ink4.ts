...
export class Contract {
    ...
    PSP22_total_supply(): Promise<Result<u128, LangError>> {
        return this.stateCall('0x162df8c2', [])
    }

    PSP22_balance_of(owner: AccountId): Promise<Result<u128, LangError>> {
        return this.stateCall('0x6568382f', [owner])
    }

    PSP22_allowance(owner: AccountId, spender: AccountId): Promise<Result<u128, LangError>> {
