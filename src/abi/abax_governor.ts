...
export const metadata = {
  source: {
    hash: "0x8d01fa6600517979f6de3da657dd098943b9c6332b6e58190e157b03664bd68a",
    language: "ink! 5.0.0",
  ...
  spec: {
    ...
    events: [
      {
        ...
        module_path: "abax_governor::modules::govern::traits::events",
        signature_topic:
      ...
      },
      {
        ...
        module_path: "abax_governor::modules::govern::traits::events",
        signature_topic:
          "0x5f5b16027cc992a83e3eedcdd887ffcbb490ffc9afb4bc3623c1e2cb54921ee4",
      },
      {
        args: [
          {
        ...
        module_path: "abax_governor::modules::govern::traits::events",
        signature_topic:
          "0xddfe7f295d992235f6a7383cea3c5a7721049996fad19b261039a5fd67ed5189",
      },
      {
        args: [
          {
        ...
        module_path: "abax_governor::modules::govern::traits::events",
        signature_topic:
          "0x2ebcdce502f12523e0670f6e293cb7ad129d9aa48f5522ae3a294e822656a4d8",
      },
      {
        args: [
          {
        ...
        module_path: "abax_governor::modules::govern::traits::events",
        signature_topic:
          "0x34110cc3e5aa20ebef66d61de2e100ad52e013b1c4ad6b1582ea4aa568fc945a",
      },
      {
        args: [
          {
      ...
      },
      {
        ...
        docs: ["Represents a deposit event in the Vault contract."],
        label: "Deposit",
        module_path: "pendzl_contracts::token::psp22::extensions::vault",
        signature_topic:
          "0xa5e5b1f0631e5f5290989092ca16eea75c92d1c382b59c7c1fd4f0bb971b5731",
      },
      {
        args: [
          {
        ...
        docs: ["Represents a withdraw event in the Vault contract."],
        label: "Withdraw",
        module_path: "pendzl_contracts::token::psp22::extensions::vault",
        signature_topic:
          "0x32d4a91f012e838e1412f7062209d065f1a86c43aeec8cb04d5e71d0da155f6e",
      },
      {
        args: [
          {
    ...
    messages: [
      ...
      },
      {
        ...
        default: false,
        docs: [],
        label: "AbaxGovernView::description_url_by_proposal_id",
        mutates: false,
        payable: false,
        returnType: {
          displayName: ["ink", "MessageResult"],
      ...
      },
      {
        ...
        default: false,
        docs: [],
        label: "AbaxGovernView::description_hash_by_proposal_id",
        mutates: false,
        payable: false,
        returnType: {
          displayName: ["ink", "MessageResult"],
                ...
                struct: {
                  fields: [
                    ...
                    },
                    {
                      ...
                      name: "proposal_id_to_description_url",
                    },
                    {
                      layout: {
                        root: {
                      ...
                      name: "proposal_id_to_description_hash",
                    },
                    {
                      layout: {
                        root: {
  ...
  types: [
            ...
            fields: [
              {
                ...
                type: 127,
                typeName:
                  "<AccessControlData as::ink::storage::traits::AutoStorableHint<::\nink::storage::traits::ManualKey<2310622986u32, ()>,>>::Type",
              },
              {
                name: "psp22",
                type: 128,
                typeName:
                  "<PSP22Data as::ink::storage::traits::AutoStorableHint<::ink::\nstorage::traits::ManualKey<2948860670u32, ()>,>>::Type",
              },
              {
                name: "vault",
                type: 129,
                typeName:
                  "<PSP22VaultData as::ink::storage::traits::AutoStorableHint<::ink\n::storage::traits::ManualKey<2222233519u32, ()>,>>::Type",
              },
              {
                name: "metadata",
                type: 130,
                typeName:
                  "<PSP22MetadataData as::ink::storage::traits::AutoStorableHint<::\nink::storage::traits::ManualKey<2375398307u32, ()>,>>::Type",
              },
              {
                name: "govern",
                type: 131,
                typeName:
                  "<GovernData as::ink::storage::traits::AutoStorableHint<::ink::\nstorage::traits::ManualKey<1234667508u32, ()>,>>::Type",
              },
              {
                name: "counter",
                type: 132,
                typeName:
                  "<VaultCounterData as::ink::storage::traits::AutoStorableHint<::ink\n::storage::traits::ManualKey<918425549u32, ()>,>>::Type",
              },
              {
                name: "lock",
                type: 133,
                typeName:
                  "<LockedSharesData as::ink::storage::traits::AutoStorableHint<::ink\n::storage::traits::ManualKey<762233120u32, ()>,>>::Type",
              },
              {
                name: "unstake",
                type: 134,
                typeName:
                  "<UnstakeData as::ink::storage::traits::AutoStorableHint<::ink::\nstorage::traits::ManualKey<2171339137u32, ()>,>>::Type",
              },
            ],
          },
        },
        path: ["abax_governor", "abax_governor", "AbaxGovernor"],
      },
    },
    {
      id: 127,
    ...
    },
    {
      ...
      type: {
        ...
        path: ["pendzl_lang", "math", "operations", "Rounding"],
      },
    },
    {
      id: 173,
...
export class Contract {
  ...
  AbaxGovernView_hash_description(
    description: String
  ): Promise<Result<Hash, LangError>> {
    return this.stateCall("0x5fab4200", [description]);
  }

  AbaxGovernView_hash_by_id(
    proposal_id: number
  ): Promise<Result<Hash | undefined, LangError>> {
  ...
  AbaxGovernView_status(
    proposal_id: number
  ): Promise<Result<ProposalStatus | undefined, LangError>> {
    return this.stateCall("0x25459c14", [proposal_id]);
  }

  AbaxGovernView_minimum_to_finalize(
    proposal_id: number
  ): Promise<Result<Balance | undefined, LangError>> {
    return this.stateCall("0xed144b89", [proposal_id]);
  }

  AbaxGovernView_state(
    proposal_id: number
  ): Promise<Result<ProposalState | undefined, LangError>> {
    return this.stateCall("0x75267b5f", [proposal_id]);
  }

  AbaxGovernView_vote_of_for(
    account: AccountId,
    proposal_id: number
  ): Promise<Result<UserVote | undefined, LangError>> {
    return this.stateCall("0xee1d4716", [account, proposal_id]);
  }

  AbaxGovernView_last_force_unstakes(
    account: AccountId
  ): Promise<Result<number | undefined, LangError>> {
    return this.stateCall("0x33481a19", [account]);
  }

  AbaxGovernView_last_stake_timestamp(
    account: AccountId
  ): Promise<Result<Timestamp | undefined, LangError>> {
  ...
  AbaxGovernView_description_url_by_proposal_id(
    proposal_id: number
  ): Promise<Result<String | undefined, LangError>> {
    return this.stateCall("0x3a9aa8b0", [proposal_id]);
  }

  AbaxGovernView_description_hash_by_proposal_id(
    proposal_id: number
  ): Promise<Result<Hash | undefined, LangError>> {
    return this.stateCall("0xf8858719", [proposal_id]);
  }

  ProvideVestScheduleInfo_get_waiting_and_vesting_durations(): Promise<
    Result<[Timestamp, Timestamp], LangError>
  > {
  ...
  PSP22Vault_convert_to_shares(
    assets: Balance,
    round: Rounding
  ): Promise<Result<Result<Balance, MathError>, LangError>> {
    return this.stateCall("0xc3722f26", [assets, round]);
  }

  PSP22Vault_convert_to_assets(
    shares: Balance,
    round: Rounding
  ): Promise<Result<Result<Balance, MathError>, LangError>> {
  ...
  AccessControl_get_role_admin(
    role: number
  ): Promise<Result<number, LangError>> {
...
export type Vote =
  | Vote_Agreed
  | Vote_Disagreed
  | Vote_DisagreedWithProposerSlashing;
...
export type ProposalStatus =
  | ProposalStatus_Active
  | ProposalStatus_Defeated
  | ProposalStatus_DefeatedWithSlash
  | ProposalStatus_Executed
  | ProposalStatus_Succeeded;
...
export type Message =
  | Message_AbaxGovernManage_change_unstake_period
  | Message_AbaxGovernManage_change_voting_rules
  | Message_AbaxGovernView_active_proposals
  | Message_AbaxGovernView_description_hash_by_proposal_id
  | Message_AbaxGovernView_description_url_by_proposal_id
  | Message_AbaxGovernView_executed_proposals
  | Message_AbaxGovernView_finalized_proposals
  | Message_AbaxGovernView_hash
  | Message_AbaxGovernView_hash_by_id
  | Message_AbaxGovernView_hash_description
  | Message_AbaxGovernView_last_force_unstakes
  | Message_AbaxGovernView_last_stake_timestamp
  | Message_AbaxGovernView_minimum_to_finalize
  | Message_AbaxGovernView_next_proposal_id
  | Message_AbaxGovernView_rules
  | Message_AbaxGovernView_state
  | Message_AbaxGovernView_status
  | Message_AbaxGovernView_vester
  | Message_AbaxGovernView_vote_of_for
  | Message_AbaxGovern_execute
  | Message_AbaxGovern_finalize
  | Message_AbaxGovern_force_unstake
  | Message_AbaxGovern_propose
  | Message_AbaxGovern_vote
  ...
  | Message_PSP22Vault_asset
  | Message_PSP22Vault_convert_to_assets
  | Message_PSP22Vault_convert_to_shares
  | Message_PSP22Vault_deposit
  | Message_PSP22Vault_max_deposit
  | Message_PSP22Vault_max_mint
  | Message_PSP22Vault_max_redeem
  | Message_PSP22Vault_max_withdraw
  | Message_PSP22Vault_mint
  | Message_PSP22Vault_preview_deposit
  | Message_PSP22Vault_preview_mint
  | Message_PSP22Vault_preview_redeem
  | Message_PSP22Vault_preview_withdraw
  | Message_PSP22Vault_redeem
  | Message_PSP22Vault_total_assets
  | Message_PSP22Vault_withdraw
  ...
  | Message_ProvideVestScheduleInfo_get_waiting_and_vesting_durations
...
export interface Message_AbaxGovernView_description_hash_by_proposal_id {
  __kind: "AbaxGovernView_description_hash_by_proposal_id";
  proposalId: number;
}

export interface Message_AbaxGovernView_description_url_by_proposal_id {
  __kind: "AbaxGovernView_description_url_by_proposal_id";
  proposalId: number;
}
...
export type Event =
  | Event_Approval
  | Event_Deposit
  | Event_ProposalCreated
  | Event_ProposalExecuted
  | Event_ProposalFinalized
  | Event_RoleAdminChanged
  | Event_RoleGranted
  | Event_RoleRevoked
  | Event_TokenReleased
  | Event_Transfer
  | Event_UnstakePeriodChanged
  | Event_VestingScheduled
  | Event_VoteCasted
  | Event_VotingRulesChanged
  | Event_Withdraw;
